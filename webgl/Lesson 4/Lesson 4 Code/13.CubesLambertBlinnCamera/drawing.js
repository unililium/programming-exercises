...
var	cubeViewWorldMatrix = new Array();
...
function main(){
	...
	if(gl){
		...
		vertexMatrixPositionHandle = gl.getUniformLocation(shaderProgram, 'pMatrix');
		...
		console.log(vertexPositionHandle + "  " + vertexNormalHandle);
		console.log(matrixPositionHandle + "  " + normalMatrixPositionHandle);
		console.log(vertexMatrixPositionHandle + "  " + materialDiffColorHandle);
		console.log(lightDirectionHandle + "  " + lightColorHandle);
		//console.log(eyePositionHandle + "  " + materialSpecColorHandle);
		console.log(materialSpecPowerHandle + "  "  );
...
function computeMatrices(){
	...
	for(i = 0; i < 4; i++){
		...
		cubeViewWorldMatrix[i] = utils.multiplyMatrices(viewMatrix, cubeWorldMatrix[i]);
	}
...
function drawScene(){
		...
		for(i = 0; i < 4; i++){
			...
			gl.uniformMatrix4fv(vertexMatrixPositionHandle, gl.FALSE, utils.transposeMatrix(cubeViewWorldMatrix[i]));
			
			if (i < 3) gl.uniformMatrix4fv(normalMatrixPositionHandle, gl.FALSE, utils.transposeMatrix(cubeViewWorldMatrix[i]));
			...
			gl.uniform3f(lightDirectionHandle,  directionalLightModified[0],
												directionalLightModified[1],
												directionalLightModified[2]);
