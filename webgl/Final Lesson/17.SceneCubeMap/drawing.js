...
var	shaderProgram = new Array(3); //Three handles, one for each shaders' couple. 0 = goureaud; 1 = phong; 2 = map
...
var vertexNormalHandle = new Array(3);
var vertexPositionHandle = new Array(3);
var vertexUVHandle = new Array(3);
var textureFileHandle = new Array(3);
var textureInfluenceHandle = new Array(3);

var matrixPositionHandle = new Array(3);
var	materialDiffColorHandle = new Array(3);
var lightDirectionHandle = new Array(3);
var lightPositionHandle = new Array(3);
var lightColorHandle  = new Array(3);
var lightTypeHandle = new Array(3);
var	eyePositionHandle = new Array(3);
var materialSpecColorHandle = new Array(3);
var materialSpecPowerHandle  = new Array(3);
...
var selectedShader = currentShader;
...
console.log("Matrixhandle " + i + " : " +matrixPositionHandle[i]);			
...
function drawScene(){
		...
		for(i=0; i < sceneObjects; i++){
			if (i==0) currentShader = 2; //Cube map for the cube only
			else currentShader = selectedShader;
